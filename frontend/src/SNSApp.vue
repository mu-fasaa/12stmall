...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'OrderMgnt', 
                description: 'OrderMgnt을 관리하는 화면입니다.', 
                key: 'orderMgnts', 
                route: '/orders/orderMgnts',
                ImageUrl: '',
            },
            { 
                title: 'Delivery', 
            ...
            { 
                title: 'SearchProdcut', 
                description: 'Search prodcut을 관리하는 화면입니다.', 
                key: 'searchProdcuts', 
                route: '/orders/searchProdcuts',
                ImageUrl: '',
            },
